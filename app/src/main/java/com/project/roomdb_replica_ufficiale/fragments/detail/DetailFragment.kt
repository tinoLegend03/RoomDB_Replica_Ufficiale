...
class DetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        mRicettaViewModel.getRicettaConIstruzioni(nomeRicetta).observe(viewLifecycleOwner) { dati ->
            ...
            binding.descrizioneTextView.text = dati.ricetta.descrizione
            binding.durataTextView.text = "${dati.ricetta.durata} min"
            binding.categoriaTextView.text = dati.ricetta.categoria
            binding.difficoltaTextView.text = dati.ricetta.livello
